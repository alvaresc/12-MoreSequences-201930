...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        center1 = circles[k].center
        radius1 = circles[k].radius
        ul_point = rg.Point(center1.x - radius1,center1.y - radius1)
        br_point = rg.Point(center1.x + radius1,center1.y + radius1)
        rectangle1 = rg.Rectangle(ul_point,br_point)
        rect_list = rect_list + [rectangle1]
